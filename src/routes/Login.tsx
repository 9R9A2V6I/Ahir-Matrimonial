      ...
      <div className='w-11/12 absolute'>
        ...
        <div className='w-11/12 flex justify-center items-center mt-4'>
          <div className='w-6/12'>
            <h1 className='heading w-11/12 text-[45px] font-semibold text-white leading-[55px]'>
              Ahir Yadav Vivah Made Easy – Connect. Communicate. Commit.
            </h1>
            <p className='title w-10/12 text-[22px] font-light text-red-100 leading-[35px] mt-5'>
              A trusted platform for the Ahir Yadav community to find meaningful matrimonial connections.
            </p>
          </div>
          <div className='w-6/12 flex justify-end items-center'>
            <form onSubmit={handleSubmit} className='w-8/12 h-[450px] bg-black/40 rounded-md p-3'>
              <div className='mt-3'>
