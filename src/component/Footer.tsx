...
function Footer() {
  return (
    <>
      <div className="w-full bg-footerBg lg:h-96 h-80 mt-5 flex justify-center items-center flex-col">
        ...
        <p className="lg:text-[15px] font-meduim text-[10px] mt-2 lg:w-6/12 w-10/12 text-white text-center">यह वेबसाइट अहीर यादव समाज भोपाल के नाम से बनाई गई है। http://www.nimarahiryadavsamaj.com इसका उद्देश्य है कि देश भर में रह रहे अहीर यादव समाज को एक साथ जोड़ना है, जो भी सामाजिक बंधु समाज से जुड़ना चाहता है तो वह बेबसाइट पर सदस्यता फार्म भर सकता है। ओर आपके परिवार में विवाह योग्य युवक – युवती का बायोडाटा इस मोबाइल नम्बर पर +91-9999999999 व्हाट्सएप कर सकते है। जिससे युवक -युवतियों के रिश्ते ( शादी ) के योग्य युवक – युवतियों शादी के बंधन में बंध सके. ( यह सुविधा निःशुल्क है)। जय माधव – जय यादव</p>
          ...
          <div className="flex justify-center items-center gap-2 lg:gap-8 mt-5 w-full">
            <h1 className="lg:text-[18px]  text-[14px] lg:font-semibold font-medium heading text-white">Home</h1>
            <h1 className="lg:text-[18px]  text-[14px] lg:font-semibold font-medium heading text-white">Bribe</h1>
            <h1 className="lg:text-[18px]  text-[14px] lg:font-semibold font-medium heading text-white">Groom</h1>
            <h1 className="lg:text-[18px]  text-[14px] lg:font-semibold font-medium heading text-white">Programs</h1>
            <h1 className="lg:text-[18px]  text-[14px] lg:font-semibold font-medium heading text-white">Gallery</h1>
            <h1 className="lg:text-[18px]  text-[14px] lg:font-semibold font-medium heading text-white">BioData</h1>
            <h1 className="lg:text-[18px]  text-[14px] lg:font-semibold font-medium heading text-white">Contact Us</h1>
          </div>
          <hr className="w-7/12 h-[2px] bg-white mt-3" />
